...
# ╔═╡ 412b0bf6-f337-11ec-1a2a-6db2afe640b1
using DifferentialEquations, Plots

# ╔═╡ 6f48a8bf-dae1-4f65-a57a-68ca0db39b32
begin
	u0 = 0
	Tmax = 30
	Tmin = 18
...
# ╔═╡ 1f2ed13b-277a-4f34-8beb-bba99a484cf3
cp_cb = ContinuousCallback(guard,output!)

# ╔═╡ b841435b-57c0-4646-83c0-7b8c03f24362
p = [α, 50, 2, 0]

# ╔═╡ b94a4f05-5b53-4182-9d21-725f3ad4aa02
begin
	tspan = (0.0,10)
	prob = ODEProblem(thermostat,u0,tspan, p, callback=cp_cb)
	sol = solve(prob, Tsit5(), reltol=1e-8, abstol=1e-8)
end

# ╔═╡ 536690c6-0e91-4f99-a58c-07a0951f77f7
begin
